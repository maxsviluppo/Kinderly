...
import { AppSection, Student, StaffMember, ClassRoom, FinancialRecord, SchoolConfig, AttendanceRecord, DisciplinaryAction, MaintenanceTask, MedicalCheck, DailyMenu, CanteenExpense } from './types';
...
export const MOCK_SCHOOL_CONFIG: SchoolConfig = {
  ...
  isSaturdayOpen: true // Configurazione sabato
};
...
export const MOCK_CLASSES: ClassRoom[] = [
  {
    ...
    capacity: 25,
    teachers: [
      { teacherId: '1', role: 'Prevalente', hoursPerWeek: 25, rotationFrequency: 'none' },
      { teacherId: '3', role: 'Religione', hoursPerWeek: 2, rotationFrequency: 'weekly' }
    ],
  ...
  },
  {
    ...
    capacity: 25,
    teachers: [
      { teacherId: '2', role: 'Sostegno', hoursPerWeek: 18, rotationFrequency: 'daily' }
    ],
...
export const WEEKLY_MENU: DailyMenu[] = [
  {
    day: 'Lunedì',
    firstCourse: { name: 'Pasta al pomodoro', ingredients: ['Pasta', 'Pomodoro', 'Olio Bio'], allergens: ['Glutine'], foodCost: 1.20 },
    secondCourse: { name: 'Polpette di manzo', ingredients: ['Manzo', 'Uova', 'Pangrattato'], allergens: ['Uova', 'Glutine'], foodCost: 2.50 },
    side: { name: 'Purè di patate', ingredients: ['Patate', 'Latte', 'Burro'], allergens: ['Latte'], foodCost: 0.80 },
    fruit: { name: 'Mela', ingredients: ['Mela'], allergens: [], foodCost: 0.40 }
  },
  {
    day: 'Martedì',
    firstCourse: { name: 'Risotto allo zafferano', ingredients: ['Riso', 'Zafferano', 'Brodo'], allergens: [], foodCost: 1.50 },
    secondCourse: { name: 'Filetto di platessa', ingredients: ['Platessa', 'Limone'], allergens: ['Pesce'], foodCost: 3.00 },
    side: { name: 'Erbette ripassate', ingredients: ['Bietole', 'Olio'], allergens: [], foodCost: 1.00 },
    fruit: { name: 'Banana', ingredients: ['Banana'], allergens: [], foodCost: 0.50 }
  },
  {
    day: 'Mercoledì',
    firstCourse: { name: 'Pasta e fagioli', ingredients: ['Pasta', 'Fagioli', 'Sedano'], allergens: ['Glutine', 'Sedano'], foodCost: 1.30 },
    secondCourse: { name: 'Frittata alle verdure', ingredients: ['Uova', 'Zucchine', 'Carote'], allergens: ['Uova'], foodCost: 1.80 },
    side: { name: 'Carote julienne', ingredients: ['Carote', 'Limone'], allergens: [], foodCost: 0.60 },
    fruit: { name: 'Pera', ingredients: ['Pera'], allergens: [], foodCost: 0.45 }
  },
  {
    day: 'Giovedì',
    firstCourse: { name: 'Lasagna bianca', ingredients: ['Pasta', 'Besciamella', 'Formaggio'], allergens: ['Glutine', 'Latte'], foodCost: 2.20 },
    secondCourse: { name: 'Spezzatino di tacchino', ingredients: ['Tacchino', 'Piselli'], allergens: [], foodCost: 2.80 },
    side: { name: 'Piselli al vapore', ingredients: ['Piselli'], allergens: [], foodCost: 0.90 },
    fruit: { name: 'Uva', ingredients: ['Uva'], allergens: [], foodCost: 0.60 }
  },
  {
    day: 'Venerdì',
    firstCourse: { name: 'Minestrone di verdure', ingredients: ['Verdure Miste', 'Patate'], allergens: ['Sedano'], foodCost: 1.40 },
    secondCourse: { name: 'Bastoncini di pesce', ingredients: ['Merluzzo', 'Pangrattato'], allergens: ['Pesce', 'Glutine'], foodCost: 2.60 },
    side: { name: 'Insalata mista', ingredients: ['Lattuga', 'Pomodorini', 'Mais'], allergens: [], foodCost: 0.70 },
    fruit: { name: 'Macedonia', ingredients: ['Frutta Mista'], allergens: [], foodCost: 1.00 }
  },
];

export const CANTEEN_EXPENSES: CanteenExpense[] = [
  { id: '1', date: '2023-10-15', item: 'Frutta e Verdura Bio', vendor: 'Orto di Marco', amount: 245.50, category: 'Fresco' },
  { id: '2', date: '2023-10-18', item: 'Carni e Latticini', vendor: 'Fattoria San Giuseppe', amount: 412.30, category: 'Fresco' },
  { id: '3', date: '2023-10-20', item: 'Prodotti Secchi', vendor: 'Metro Cash & Carry', amount: 189.90, category: 'Dispensa' },
];
